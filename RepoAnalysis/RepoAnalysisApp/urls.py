...
urlpatterns = [
    ...
    path('index/<str:scan_session>/project-create/', views.project_create, name='project-create'),
    path('index/<str:scan_session>/project-edit/<int:pk>', views.project_edit, name='project-edit'),
    path('index/<str:scan_session>/project-delete/<int:pk>', views.project_delete, name='project-delete'),
