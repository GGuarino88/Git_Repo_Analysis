...
git clone -b production https://github.com/GGuarino88/Git_Repo_Analysis.git /Git_Repo_Analysis
...
## Start the Project
CMD ["sh", "-c", "python3 manage.py runserver 0.0.0.0:80 2>&1 | tee runserver.log"]